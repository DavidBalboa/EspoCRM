    ...
    'entityDefs' => (object) [
        ...
        'Beneficiario' => (object) [
            'fields' => (object) [
                ...
                'direccinState' => (object) [
                    'type' => 'varchar',
                    'trim' => true
                ],
                'direccinCountry' => (object) [
                    'type' => 'varchar',
                    'trim' => true
                ],
                'direccinPostalCode' => (object) [
                    'type' => 'varchar',
                    'trim' => true
                ],
                'direccinMap' => (object) [
        ...
        'Beneficios' => (object) [
            'fields' => (object) [
                ...
                'direccionStreet' => (object) [
                    'type' => 'text',
                    'maxLength' => 255,
                    'dbType' => 'varchar'
                ],
                'direccionCity' => (object) [
                    'type' => 'varchar',
                    'trim' => true
                ],
                'direccionState' => (object) [
                    'type' => 'varchar',
                    'trim' => true
                ],
                'direccionCountry' => (object) [
                    'type' => 'varchar',
                    'trim' => true
                ],
                'direccionPostalCode' => (object) [
                    'type' => 'varchar',
                    'trim' => true
                ],
                'direccionMap' => (object) [
